...
return render_template('index.html', variable1= country1,
                                     variable2 = df[origin].value_counts().to_frame(),
                                     
                                     variable3 = df.at[origin, "Freedom_Score"],
                                     variable4 = int(df.at[origin, "Rank"],
                                     variable4a = countrydata.at[origin,"GrowthRate"],
                                     
                                     variable5= country2,
                                     variable5a = df[origin].value_counts().to_frame(),
                                     
                                     variable5b = df.at[destination, "Freedom_Score"],
                                     variable5c = int(df.at[destination, "Rank"],
                                     variable5d = countrydata.at[destination,"GrowthRate"])
